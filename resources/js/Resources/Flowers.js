    ...
    let Flowers = [
        {
            ...
            onDamage: (plant, resource, plants, enemies, projectiles, x, y)=>{},
            ...
            onLevel: (plant, resource, plants, enemies, projectiles, x, y)=>{
                plant.level += 1;
                plant.damage += (plant.baseDamage * 0.1);
                plant.ability += (plant.baseAbility * 0.1);
                plant.maxmana += (plant.baseMaxmana * 0.1);
                plant.manaRegen += (plant.baseManaRegen * 0.1);
                plant.nextLevelExp += (plant.nextLevelExp * 1.2);
            },
